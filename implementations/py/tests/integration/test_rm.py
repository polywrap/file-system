...
async def test_rm_valid_file_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rm_non_existing_file_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rm_non_existing_dir_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rm_empty_directory_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rm_non_empty_directory_without_recursive_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rm_non_empty_directory_recursive_integration(client: PolywrapClient, temp_dir: Path):
    non_empty_dir = temp_dir / "non_empty_dir"
    os.mkdir(non_empty_dir)
    file_path = non_empty_dir / "test_file.txt"
    with open(file_path, "w") as f:
...
async def test_rm_non_empty_directory_force_no_recursive_integration(client: PolywrapClient, temp_dir: Path):
    non_empty_dir = temp_dir / "non_empty_dir"
    os.mkdir(non_empty_dir)
    file_path = non_empty_dir / "test_file.txt"
    with open(file_path, "w") as f:
...
async def test_rm_non_empty_directory_recursive_and_force_integration(client: PolywrapClient, temp_dir: Path):
    non_empty_dir = temp_dir / "non_empty_dir"
    os.mkdir(non_empty_dir)
    file_path = non_empty_dir / "test_file.txt"
    with open(file_path, "w") as f:
