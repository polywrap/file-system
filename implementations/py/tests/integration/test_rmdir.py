...
async def test_rmdir_empty_directory_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rmdir_non_empty_directory_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_rmdir_non_existing_directory_integration(client: PolywrapClient, temp_dir: Path):
