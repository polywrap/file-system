...
async def test_write_file_new_file_integration(client: PolywrapClient, temp_dir: Path):
...
async def test_write_file_overwrite_existing_integration(client: PolywrapClient, temp_dir: Path):
